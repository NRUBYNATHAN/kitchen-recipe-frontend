...
const getrecipe=()=>{
  ...
  return (
    ...
    <div>
   <img className="dish" src="https://www.mygfguide.com/wp-content/uploads/2020/01/IMG_20200118_191348-1024x768.jpg"/>
          <p className="flag1">Low Quantity Recipes</p>
        <div className="list">
            {recipelist.map((mv) => (<Lowdata key={mv.id} data={mv} />))}
        </div>
        </div>
    </div>
 )};

 function Lowdata({data}){
  return (
