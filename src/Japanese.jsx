...
const getrecipe=()=>{
  fetch(`${API}/cuisines/data?cuisines=japanese`)
      .then((val) => val.json())
  ...
  return (
    ...
    <div>
      <img className="flag" src="https://media.istockphoto.com/id/511092543/photo/close-up-of-japans-flag.jpg?s=612x612&w=0&k=20&c=o0-hOJliHlsN7FF9N7Y-WqF8pwGDu07JPed98jjr2hM="/>
          <p className="flag1">Japanese Cuisines</p>
        <div className="list">
            {recipelist.map((mv) => (<Japanesedata key={mv.id} data={mv} />))}
        </div>
        </div>
    </div>
 )};

 function Japanesedata({data}){
  return (
